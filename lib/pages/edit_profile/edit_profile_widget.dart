                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => TextFormField(
                              controller: _model.medicalAidController,
                              focusNode: _model.medicalAidFocusNode,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              style: FlutterFlowTheme.of(context).bodyMedium,
                              validator: _model.medicalAidControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => TextFormField(
                              controller: _model.policyNumberController,
                              focusNode: _model.policyNumberFocusNode,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              validator: _model.policyNumberControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => FlutterFlowDropDown<String>(
                              controller: _model.bloodTypeValueController ??=
                                ...
                                _model.bloodTypeValue ??= valueOrDefault(
                              ...
                              onChanged: (val) =>
                                  setState(() => _model.bloodTypeValue = val),
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Specify any allergies...',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await currentUserReference!
                                  ...
                                  medicalAid: _model.medicalAidController.text,
                                  policyNumber:
                                      _model.policyNumberController.text,
                                  ...
                                  await showDialog<bool>(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: Text(
                                                'You are about to delete your profile. Are you sure?'),
                                            actions: [
                                              TextButton(
