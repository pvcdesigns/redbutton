...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFDF2B2E);
  late Color secondary = const Color(0xFF39D252);
  ...
  late Color success = const Color(0xFF39D252);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFDF2B2E);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFDF2B2E);
  late Color secondary = const Color(0xFF39D252);
  late Color tertiary = const Color(0xFFA2A2A2);
  ...
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFF384047);
  late Color success = const Color(0xFF39D252);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFDF2B2E);
  late Color info = const Color(0xFFFFFFFF);
